	        	...
	        	if(!$('#fare_distance_buffer_1').is(":visible")){
	        		...
	        		$('#fare_table').append('\
	                		<div class="row col-lg-12 col-sm-12 col-xs-12">\
	        				  <div class="col-md-3 "><input type="text" class="form-control" name="fare_dist1[]" placeholder="0.0"></div>\
	        				  <div class="col-md-3"><input type="text" class="form-control"  name="fare_dist2[]" placeholder="0.0"></div>\
	        				  <div class="col-md-3">\
	...
	$( "#edit_fare" ).click(function() {
		...
		if(editable_fare){
			 $("input[name='tab_fare_structure_radioBtns']").prop('disabled', false);
			    ...
			    $("input[name='fare_distance1_mile']").prop('disabled', false);
			 ...
			 $("input[name='tab_fare_structure_radioBtns']").prop('disabled', true);
			    ...
			    $("input[name='fare_distance1_mile']").prop('disabled', true);
