...
public class _CentralBuchanA2BService extends Operator{
	...
	public _CentralBuchanA2BService(String name, String description, String elig, 
	...
	public _CentralBuchanA2BService() {
		super("Central Buchan A2B service"
				, ""
				, ""
				, ""
				, ""
...
//		eligiblePassengers = PassengerType.values();
	}
